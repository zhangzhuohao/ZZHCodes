...
FPs_correct_presses                =       shape_it(rb.Foreperiods(rb.CorrectIndex));
...
t_releases                                    =        shape_it(rb.EventTimings(rb.EventMarkers == ind_release));
...
t_rewards                    =       shape_it(rb.EventTimings(rb.EventMarkers == ind_rewards));
