classdef GPSColor
    ...
    methods
        ...
        function show(obj)
            figure(21); clf(21);
            set(gcf, 'unit', 'centimeters', 'position',[2 2 8 12], 'paperpositionmode', 'auto', 'color', 'w')
            ...
            ha1 = axes;
            set(ha1, 'units', 'centimeters', 'position', [0.5 0.5 4 11], ...
                'nextplot', 'add', 'xcolor', 'none', 'ycolor', 'none', 'color', 'w', ...
                'ylim', [0 15], 'xlim', [0 1], 'ydir', 'reverse')            
            ...
            ha2 = axes;
            set(ha2, 'units', 'centimeters', 'position', [5 0.5 4 11], ...
