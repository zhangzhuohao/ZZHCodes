...
% performance track
draw_perf_track(obj, fig_session, [1.2 4 5 4.5], ax_sz_4, obj.PerformanceTrack(1:2,:), ls(1:2), lw(1:2));
...
obj.plot_violin_compare(ax_rt_v, obj.RTSorted(1:2,1), obj.RTSorted(1:2,2), obj.BandWidth, ...
    "Color", {GPSColor.PortL, GPSColor.PortR}, "TextMedian", true, "cate_name", obj.TargetFP(1:2), 'Scale', 1000);
...
for j = 1:2
    ...
    b = bar(ax{j}, 1:2, 100*table2array(obj.Performance(id, end-3:end)), 'EdgeColor', 'none');
    for k = 1:4
