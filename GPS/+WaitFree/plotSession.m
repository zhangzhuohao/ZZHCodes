...
set(gcf, 'unit', 'centimeters', 'position',[2 2 22 17.2], 'paperpositionmode', 'auto', 'color', 'w')
...
%% Plot shuttle time
ha4 = axes;
set(ha4, 'units', 'centimeters', 'position', [1.5+plotsize1(1)+1 16-plotsize1(2)-1, plotsize1], 'nextplot', 'add', ...
...
ha5 = axes;
set(ha5, 'units', 'centimeters', 'position', [1.5+2*plotsize1(1)+1.5 16-plotsize1(2)-1, plotsize2], 'nextplot', 'add', 'ylim', [0 3], ...
...
ha6 = axes;
set(ha6, 'units', 'centimeters', 'position', [1.5+plotsize1(1)+1 16-2*plotsize1(2)-2, plotsize1], 'nextplot', 'add', ...
...
ha7 = axes;
set(ha7, 'units', 'centimeters', 'position', [1.5+2*plotsize1(1)+1.5 16-2*plotsize1(2)-2, plotsize2], 'nextplot', 'add', 'ylim', [0 3], ...
...
%% Plot reaction time
ha8 = axes;
set(ha8, 'units', 'centimeters', 'position', [1.5+plotsize1(1)+1 16-3*plotsize1(2)-3, plotsize1], 'nextplot', 'add', ...
...
ha9 = axes;
set(ha9, 'units', 'centimeters', 'position', [1.5+2*plotsize1(1)+1.5 16-3*plotsize1(2)-3, plotsize2], 'nextplot', 'add', 'ylim', [0 1], ...
    'xlim', [0 1], 'yscale', 'linear', 'yticklabel', [], 'ticklength', [0.02 0.1], 'fontsize', 8)
