...
ylabel(ax_hd_s{1}, 'WD (s)', 'FontWeight', 'bold');
...
for i = 1:length(ax_mt_s)
    title(ax_mt_s{i}, []);
    set(ax_mt_s{i}, 'YLim', [0 1]);
end
ylabel(ax_mt_s{1}, 'RT (s)', 'FontWeight', 'bold');
...
for i = 1:length(ax_mt_d)
    set(ax_mt_d{i}, 'YLim', [0 1], 'YTickLabel', []);
end
