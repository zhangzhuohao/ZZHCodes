...
text(ax_st_d{1}, ax_st_d{1}.XLim(2), .9, 'First 1/3', 'FontSize', 7, 'FontWeight', 'bold', 'HorizontalAlignment', 'right');
text(ax_st_d{2}, ax_st_d{2}.XLim(2), .9, 'Last 1/3', 'FontSize', 7, 'FontWeight', 'bold', 'HorizontalAlignment', 'right');
...
function ax = draw_perf_bars(obj, fig, pos, ax_sz, code, lb)
    ...
    for j = 1:2
        ...
        b = bar(ax{j}, code, 100*table2array(obj.Performance(id, end-3:end)));
        for i = 1:4
