classdef GPSProgressKbClass
    ...
    methods
        ...
        function value = get.HDSortedAll(obj)
            ...
            for j = 1:length(obj.Ports)
                for i = 1:length(obj.CueUncue)
                    ind_thisFP = obj.BehavTable.Stage==1 & obj.BehavTable.Cued==obj.CueUncue(i) & eval("obj.Ind.port" + obj.Ports(j));
        ...
        function value = get.HDSortedNone(obj)
            ...
            for j = 1:length(obj.Ports)
                for i = 1:length(obj.CueUncue)
                    ind_thisFP = sessions_ind & obj.BehavTable.Stage==1 & obj.BehavTable.Cued==obj.CueUncue(i) & eval("obj.Ind.port" + obj.Ports(j));
                    iHDs = obj.BehavTable.HoldDuration(find(ind_thisFP));
